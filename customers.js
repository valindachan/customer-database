const customers = {
  results: [
    {
      gender: "male",
      name: { title: "mr", first: "curtis", last: "ryan" },
      location: {
      ...
      login: {
        ...
        sha256:
          "4a9e0d3fd2cafc6f6a1fc05cd6b35ceb0cfe08fa2b9abc07f3bfad5c977be86c"
      },
      dob: "1967-10-29 09:16:09",
      registered: "2007-01-12 19:26:30",
      phone: "(518)-664-5821",
      cell: "(385)-917-9080",
      id: { name: "SSN", value: "544-97-7715" },
      picture: {
    ...
    {
      gender: "male",
      name: { title: "mr", first: "martin", last: "terry" },
      location: {
      ...
      login: {
        ...
        sha256:
          "7f99df6b12dc28f0f335cf087126dde49c74dba55ec13efce745af9e1a24c555"
      },
      dob: "1987-10-08 08:46:52",
      registered: "2007-10-13 07:57:48",
      phone: "(455)-018-0151",
      cell: "(863)-366-8588",
      id: { name: "SSN", value: "090-34-5018" },
      picture: {
    ...
    {
      gender: "female",
      name: { title: "miss", first: "christine", last: "cooper" },
      location: {
      ...
      login: {
        ...
        sha256:
          "384dff47c2b45232df9a1abcdde3217ee7b44ba18a2cac64dd8f1d156113db7d"
      },
      dob: "1974-02-16 14:38:20",
      registered: "2007-09-25 01:51:03",
      phone: "(953)-914-3182",
      cell: "(758)-417-5753",
      id: { name: "SSN", value: "446-75-6574" },
      picture: {
    ...
    {
      gender: "male",
      name: { title: "mr", first: "norman", last: "henderson" },
      location: {
      ...
      login: {
        ...
        sha256:
          "a1fa6f0fd58bf0d136ace57f8d372e47779c3a635613752861046c4f01d54a89"
      },
      dob: "1975-04-03 23:36:46",
      registered: "2009-03-17 08:13:20",
      phone: "(563)-864-2175",
      cell: "(053)-397-4254",
      id: { name: "SSN", value: "472-23-6671" },
      picture: {
    ...
    {
      gender: "male",
      name: { title: "mr", first: "jose", last: "rhodes" },
      location: {
      ...
      login: {
        ...
        sha256:
          "f759f43e79b1bb214367aa7816040c30e22c2affa501945d42e403d3bc57ca1f"
      },
      dob: "1955-11-10 22:15:13",
      registered: "2014-01-06 20:47:53",
      phone: "(491)-555-8040",
      cell: "(946)-535-7837",
      id: { name: "SSN", value: "290-85-8823" },
      picture: {
    ...
    {
      gender: "female",
      name: { title: "mrs", first: "pauline", last: "hughes" },
      location: {
      ...
      login: {
        ...
        sha256:
          "21f9c74f39325d869f159ddf3f092fc2995bf9f76fdf0d8ad4558c17c4964d90"
      },
      dob: "1977-12-08 16:33:56",
      registered: "2004-06-29 03:25:39",
      phone: "(184)-510-5532",
      cell: "(777)-970-7402",
      id: { name: "SSN", value: "305-43-5842" },
      picture: {
    ...
    {
      gender: "male",
      name: { title: "mr", first: "darren", last: "hunter" },
      location: {
      ...
      login: {
        ...
        sha256:
          "2e0042b225f488ba89f9399472f69da8a43c4b1e6786fcfab4abf9f07410734b"
      },
      dob: "1948-01-29 05:50:58",
      registered: "2008-11-03 10:23:45",
      phone: "(348)-718-0403",
      cell: "(571)-664-0652",
      id: { name: "SSN", value: "963-85-5649" },
      picture: {
    ...
    {
      gender: "male",
      name: { title: "mr", first: "oscar", last: "walker" },
      location: {
      ...
      login: {
        ...
        sha256:
          "0db79ca945eefec92f62e4cea67ae054b4921771ed26d7f03cb15c7b49e20278"
      },
      dob: "1995-07-13 12:34:13",
      registered: "2007-09-30 16:54:34",
      phone: "(225)-055-9383",
      cell: "(155)-427-6299",
      id: { name: "SSN", value: "017-75-9945" },
      picture: {
    ...
    {
      gender: "female",
      name: { title: "miss", first: "ann", last: "beck" },
      location: {
      ...
      login: {
        ...
        sha256:
          "82627e829749d436b499486002460d72ad08d498e5277595b7d58d9208622c58"
      },
      dob: "1982-10-08 00:07:58",
      registered: "2008-05-05 03:07:47",
      phone: "(663)-070-7094",
      cell: "(550)-019-8911",
      id: { name: "SSN", value: "371-48-5948" },
      picture: {
    ...
    {
      gender: "female",
      name: { title: "mrs", first: "harper", last: "morales" },
      location: {
      ...
      login: {
        ...
        sha256:
          "a37ebe022807e6b3516f65b3cc310cc46b6e2f5904a1b7fbf48c3d9d8a506865"
      },
      dob: "1948-12-31 15:33:52",
      registered: "2016-07-20 16:29:56",
      phone: "(428)-292-6669",
      cell: "(704)-667-9820",
      id: { name: "SSN", value: "616-15-0762" },
      picture: {
    ...
    {
      gender: "female",
      name: { title: "miss", first: "tammy", last: "hill" },
      location: {
      ...
      login: {
        ...
        sha256:
          "fbc3c31bdaeaaa0cb6bf2611479cbd3f709ed48c87d0e28bcc27ea486dacd265"
      },
      dob: "1946-06-23 13:21:17",
      registered: "2010-05-31 00:53:06",
      phone: "(726)-804-8431",
      cell: "(727)-339-8784",
      id: { name: "SSN", value: "141-67-4033" },
      picture: {
    ...
    {
      gender: "female",
      name: { title: "mrs", first: "addison", last: "graves" },
      location: {
      ...
      login: {
        ...
        sha256:
          "cf8762ee50d266cb4bc128d388766d53a48f8525477ec143499c1c4a5737e2b2"
      },
      dob: "1979-09-14 21:09:32",
      registered: "2008-09-23 14:40:38",
      phone: "(995)-211-0296",
      cell: "(302)-258-3479",
      id: { name: "SSN", value: "759-73-7891" },
      picture: {
  ...
  info: { seed: "b98b46987e52ab98", results: 12, page: 1, version: "1.1" }
}
